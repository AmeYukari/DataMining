...
class DBLP:
    ...
    def __check_features(self, features: set) -> set:
        ...
        for feature in features:
            if feature not in self.all_features:
                self.__log_msg(
                    "WARNING: Discarding feature \"{}\" as it cannot be extracted from the DBLP dump.".format(feature))
            else:
    ...
    def __extract_features(self, elements: etree._Element, features_to_extract: dict,
                           include_key_and_mdate: bool = False) -> dict:
        """
    ...
    def parse_by_year(self, year: str, dblp_path: str, save_path: str = None, features_to_extract: dict = None,
                      include_key_and_mdate: bool = False, output: str = "jsonl") -> None:
        """
    ...
    def parse_by_years(self, years: list, dblp_path: str, save_path: str = None, features_to_extract: dict = None,
                       include_key_and_mdate: bool = False, output: str = "jsonl") -> None:
        """
    ...
    def parse_all(self, dblp_path: str, save_path: str = None, features_to_extract: dict = None,
                  include_key_and_mdate: bool = False, output: str = "jsonl") -> None:
        """
